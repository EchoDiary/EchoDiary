    ...
    >
      <div className='flex h-full w-full flex-row items-stretch justify-between gap-4'>
        <div className='flex flex-col justify-center gap-4'>
          <div
            ref={div1Ref}
            className='flex flex-row z-10 items-center gap-2 p-2 px-4 border border-primary bg-white rounded-lg hover:scale-105 transition-all duration-300 hover:border-2 w-fit'
          >
        ...
        <div className='flex flex-col justify-center'>
          <div
            ref={div7Ref}
            className='flex flex-col gap-2 z-10 hover:bg-background shadow-xl bg-primary border-primary border-4 aspect-square rounded-full p-6 items-center justify-center'
          >
